    ...
    <div class="content">
        ...
        <form class="login-form" role="form" action="admin/login" method="POST">
            ...
            <div class="form-group">
                ...
                <input class="form-control form-control-solid placeholder-no-fix" type="password" id="inputPassword"
...
<![endif]-->
    ...
    <!-- END CORE PLUGINS -->
    <!-- BEGIN PAGE LEVEL PLUGINS -->
    <script src="admin_asset/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript">
    </script>
    <script src="admin_asset/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript">
    </script>
